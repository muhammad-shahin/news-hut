 ...
 * step 2: set the <AuthContextProvider> as parent component where you kept your routes (in this app we kept our routes in App.jsx)
 ...
 * step 5: Receive The Context In Any Children Element
 */
